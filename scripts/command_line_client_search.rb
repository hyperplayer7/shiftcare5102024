# scripts/command_line_client_search.rb
require 'json'
require_relative '../app/concepts/client/operations/client_search'

# ruby scripts/command_line_client_search.rb (goes to default json file stored in db/clients.json)
# ruby scripts/command_line_client_search.rb  db/clients.json (user specified json file)
# ruby scripts/command_line_client_search.rb  db/clients.jso (catch error case wrong file)
# ruby scripts/command_line_client_search.rb  Gemfile (catch error case wrong file)
# ruby scripts/command_line_client_search.rb  db/some_random.json (no error/exeptions for random json content)
